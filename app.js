...
var incompleteTaskHolder=document.querySelector(".main__complete-list");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className="main__task-adding-input";
